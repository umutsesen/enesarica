export const metadata = {
  ...
  description:
    "Fzt. Enes Arıca ile iletişime geçin ve randevu alın. Yalova, İstanbul ve İzmir iletişim kanallarımız üzerindenn size en uygun lokasyonu seçin.",
  alternates: {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.fizyoterapistenesarica.com/imgs/enes-arica.webp", width: 2048, height: 1368, alt: "Fzt. Enes Arıca - İletişim" }],
  },
};
