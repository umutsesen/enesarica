...
description: "Schroth metoduyla skolyoz fizyoterapisinde klinik yaklaşımım: uc boyutlu duzeltme, rotasyon solunumu, korse yonetimi ve bireysel egzersiz programlari."
...
faqItems:
  - question: "Skolyoz tamamen duzelebilir mi?"
    answer: "Skolyozun seyri egrilik derecesine, hastanin yasina ve tedaviye uyumuna baglidir; bireyden bireye degisir. Buyume cagindaki cocuklarda Schroth metodunun egrilik ilerlemesinin yonetiminde olumlu sonuclarla iliskilendirildigi literaturde bildirilmektedir. Eriskinlerde ise oncelikli amac agri yonetimi, postur ve yasam kalitesinin desteklenmesidir."
  - question: "Schroth egzersizlerini evde yapabilir miyim?"
    answer: "Evet, Schroth egzersizleri klinikte dogru teknik ogretildikten sonra evde de uygulanabilir. Ancak baslangicta mutlaka fizyoterapist gozetiminde calisilmasi gerekir. Yanlis uygulanan egzersizler fayda saglamayabilir veya egriligi olumsuz etkileyebilir. Ev programinin duzenli uygulanmasi surecin takibi acisindan onemlidir; sonuclar kisiden kisiye degisir."
  - question: "Hangi yasta skolyoz tedavisine baslanmali?"
    answer: "Skolyoz tedavisine mumkun oldugunca erken baslanmasi onerilir. Buyume cagindaki 10-16 yas arasi cocuklarda omurga hala sekillendirilebilir durumda oldugundan, bu donemde uygulanan tedavinin literaturde daha olumlu sonuclarla iliskilendirildigi bildirilmektedir. Eriskin skolyoz hastalarinda da agri yonetimi, fonksiyonel destek ve egrilik ilerlemesinin takibi amaciyla fizyoterapi uygulanabilir."
  - question: "Skolyoz korsesi gerekli mi?"
    answer: "Korse endikasyonu egrilik derecesine ve hastanin buyume potansiyeline gore belirlenir. Cobb acisi yaklasik 20-40 derece arasinda olan ve hala buyumesi devam eden hastalarda korse gundeme gelebilir. Schroth egzersizlerinin korse tedavisiyle birlikte uygulanmasi literaturde olumlu sonuclarla iliskilendirilmektedir. Korse karari ortopedi hekimi tarafindan verilir."
...
Skolyoz, klinik pratiğimde ozel ilgi alanlarımın başında gelen bir omurga rahatsızlığıdır. Schroth metodu konusunda edindiğim egitim ve yıllar icinde biriktirdiğim klinik deneyim, bu alanda hastalarıma kanıta dayalı ve bireyselleştirilmiş bir fizyoterapi yaklaşımı sunmamı sağlıyor. Ozellikle adolesan skolyoz hastalarında ailelerin yaşadığı kaygıyı yakından biliyorum. Bu sayfada skolyozun ne olduğunu, Schroth metodunun bilimsel temellerini ve benimsediğim tedavi yaklaşımını bilgilendirme amacıyla detaylı şekilde paylaşıyorum.
...
Skolyoz tanısında Cobb acısı olcumu kullanılır. Rontgen uzerinde eğriliğin ust ve alt uclarındaki omurlar arasındaki acı hesaplanır. 10 derecenin altındaki eğrilikler postur asimetrisi olarak değerlendirilirken, 10 derecenin uzerindeki eğrilikler skolyoz olarak tanımlanır.
...
Schroth metodunu benimsememdeki temel neden, skolyozun uc boyutlu yapısını uc boyutlu olarak ele almasıdır. Geleneksel egzersiz yaklaşımları skolyozu sadece yana eğilme olarak gorurken, Schroth metodu rotasyon ve sagittal duzlem bozukluklarını da hedefler. Bu kapsamlı yaklaşımın, skolyoza ozgu egzersiz programları icinde literaturde one cıkan bir yontem olduğunu gozlemliyorum.
...
Cobb acısı 20-40 derece arasında olan ve hala buyumesi devam eden hastalarımda, ortopedi hekimi ile işbirliği icinde korse tedavisi planlanabilir. Schroth egzersizlerinin korse ile birlikte uygulanması, tek başına korse kullanımına gore daha iyi sonuclar vermektedir.
...
Skolyoz, uc boyutlu bir omurga deformitesi olarak kapsamlı bir değerlendirme ve tedavi yaklaşımı gerektirir. Schroth metodu, bilimsel kanıtlarla desteklenen konservatif fizyoterapi yaklaşımlarından biridir ve SOSORT kilavuzlarında one cıkmaktadır. Klinik pratiğimde Schroth egzersizleri, GTOS terapi ve bireyselleştirilmiş egzersiz programlarını birlikte planlıyorum; eğrilik ilerlemesinin yonetimi, ağrı ve yaşam kalitesi acısından sonuclar kişiden kişiye değişir.
...
Skolyoz şikayetleriniz varsa veya cocuğunuzda omurga asimetrisi fark ettiyseniz, detaylı bir değerlendirme icin benimle iletişime gecebilirsiniz. [Bel fıtığı tedavisi](/tedavi-alanlari/bel-fitigi-tedavisi), [boyun fıtığı tedavisi](/tedavi-alanlari/boyun-fitigi-tedavisi) ve [GTOS terapi](/tedavi-alanlari/gtos-terapi) alanlarında da fizyoterapi hizmeti sunuyorum.
