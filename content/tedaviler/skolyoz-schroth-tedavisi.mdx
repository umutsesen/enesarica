...
faqItems:
  ...
  - question: "Schroth egzersizlerini evde yapabilir miyim?"
    answer: "Evet, Schroth egzersizleri klinikte dogru teknik ogretildikten sonra evde de uygulanabilir. Ancak baslangicta mutlaka deneyimli gozetiminde calisilmasi gerekir. Yanlis uygulanan egzersizler fayda saglamayabilir veya egriligi olumsuz etkileyebilir. Ev programi duzenli uygulandiginda tedavi sonuclari belirgin sekilde iyilesir."
...
# Skolyoz ve Schroth Tedavisi: Deneyimli Yaklasimim ve Klinik Deneyimlerim

Skolyoz, [Fizyones kliniğimde](https://www.yalovafizyoterapist.com) ozel ilgi alanlarımın başında gelen bir omurga rahatsızlığıdır. Schroth metodu konusunda edindiğim egitim ve yıllar icinde biriktirdiğim klinik deneyim, bu alanda hastalarıma kanıta dayalı ve bireyselleştirilmiş bir fizyoterapi yaklaşımı sunmamı sağlıyor. Ozellikle adolesan skolyoz hastalarında ailelerin yaşadığı kaygıyı yakından biliyorum. Bu sayfada skolyozun ne olduğunu, Schroth metodunun bilimsel temellerini ve benimsediğim tedavi yaklaşımını bilgilendirme amacıyla detaylı şekilde paylaşıyorum.
...
Skolyoz, uc boyutlu bir omurga deformitesi olarak kapsamlı ve deneyimli bir tedavi yaklaşımı gerektirir. Schroth metodu, bilimsel kanıtlarla desteklenen konservatif fizyoterapi yaklaşımlarından biridir ve SOSORT kilavuzlarında one cıkmaktadır. Klinik deneyimimde Schroth egzersizleri, GTOS terapi ve bireyselleştirilmiş egzersiz programlarını birlikte uyguluyor; uygun vakalarda eğrilik ilerlemesinin yonetimi, ağrı azalması ve yaşam kalitesi acısından olumlu yanıtlar gozlemliyorum.
...
Skolyoz şikayetleriniz varsa veya cocuğunuzda omurga asimetrisi fark ettiyseniz, detaylı bir değerlendirme icin benimle iletişime gecebilirsiniz. [Bel fıtığı tedavisi](/tedavi-alanlari/bel-fitigi-tedavisi), [boyun fıtığı tedavisi](/tedavi-alanlari/boyun-fitigi-tedavisi) ve [GTOS terapi](/tedavi-alanlari/gtos-terapi) alanlarında da deneyimli tedavi hizmeti sunuyorum.
