...
description: "Schroth metodu ile skolyoz tedavisinde deneyimli yaklasimim. 3 boyutlu duzeltme, rotasyon solunumu ve bireysel egzersiz programlari."
...
Skolyoz, [Fizyones kliniğimde](https://www.yalovafizyoterapist.com) ozel ilgi alanlarımın başında gelen bir omurga rahatsızlığıdır. Schroth metodu konusunda aldığım deneyim eğitimleri ve yıllar icinde biriktirdiğim klinik deneyim, bu alanda hastalarıma kanıta dayalı ve bireyselleştirilmiş tedavi sunmamı sağlıyor. Ozellikle adolesan skolyoz hastalarında ailelerin yaşadığı kaygıyı yakından biliyorum. Bu sayfada skolyozun ne olduğunu, Schroth metodunun bilimsel temellerini ve uyguladığım tedavi yaklaşımını detaylı şekilde paylaşıyorum.
