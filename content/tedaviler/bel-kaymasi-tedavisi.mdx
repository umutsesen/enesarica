...
Bel kaymasının "tedavi edilip biten" bir rahatsızlık olmadığını hastalarıma acıkca ifade ediyorum. Omurga stabilitesini korumak icin oğrenilen egzersizlerin yaşam boyu surdurilmesi gerekir. Literaturde, egzersiz programına duzenli uyumun ağrı yonetimi ve gunluk aktivitelere katılım acısından onemli oldugu bildirilmektedir; sonuclar kişiden kişiye değişir.
