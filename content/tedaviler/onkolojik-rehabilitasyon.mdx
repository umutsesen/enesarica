...
description: "Onkoloji ekibiyle koordineli yuruttuğum onkolojik rehabilitasyon yaklaşımım: kemoterapi yan etkileri, lenfodem yonetimi ve kanıta dayalı egzersiz recetelemesi."
...
faqItems:
  - question: "Kanser tedavisi sırasında egzersiz yapmak guvenli midir?"
    answer: "Uygun dozda ve profesyonel gozetimde yapılan egzersizin kanser tedavisi sırasında genellikle guvenli olduğu kabul edilmektedir. ACSM kanıta dayalı kılavuzları, kanser hastalarında egzersizin yorgunluğun azalması, fiziksel kapasitenin desteklenmesi ve yaşam kalitesinin iyileşmesiyle ilişkili olduğunu bildirmektedir. Egzersiz programının hastanın tedavi surecine, kan değerlerine ve genel durumuna gore bireyselleştirilmesi ve tedavi eden onkologla koordineli planlanması şarttır."
...
**Yorgunluk yonetimi:** Kanser ile ilişkili yorgunluk, literatürde hastaların buyuk bolumunde bildirilen ve en sık şikayet edilen belirtilerden biridir. Paradoks olarak, kontrollü egzersiz yorgunluk yonetiminde en cok onerilen yaklaşımlardan biridir. 2017 yılında Cochrane Database of Systematic Reviews'da yayımlanan Cramp ve Byron-Daniel'ın sistematik derlemesi, aerobik egzersizin kanser ile ilişkili yorgunluğu anlamlı duzeyde azalttığını doğrulamıştır. Hastalarıma yorgunluk duzeyine gore dozlanmış yurumuş programları, hafif direnç egzersizleri ve enerji koruma stratejileri oğretiyorum.
