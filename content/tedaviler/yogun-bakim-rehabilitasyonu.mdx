...
description: "Yogun bakım ekibiyle koordineli yuruttuğum erken mobilizasyon yaklaşımım: ICU-acquired weakness, solunum fizyoterapisi ve taburculuk sonrası takip protokolu."
...
faqItems:
  - question: "Yogun bakımda fizyoterapi guvenli midir?"
    answer: "Uygun hasta secimi ve monitorizasyon altında yogun bakımda fizyoterapinin genellikle guvenli kabul edildiği, literatürde erken mobilizasyonun advers olay oranının duşuk olduğu bildirilmektedir. Tedavi oncesinde hastanın hemodinamik stabilitesi, oksijen durumu ve sedasyon duzeyi değerlendirilir. Uygulamalar surekli monitorizasyon altında ve yogun bakım ekibiyle koordineli gercekleştirilir."
...
2010 yılında Critical Care Medicine dergisinde yayımlanan Stevens ve arkadaşlarının derlemesi, ICU-acquired weakness'in ventilatoreden ayırma başarısızlığının en onemli nedenlerinden biri olduğunu ve erken mobilizasyonun bu durumun onlenmesinde etkili bir strateji olduğunu vurgulamıştır.
...
Yogun bakım rehabilitasyonu, ekip calışması gerektiren bir alandır. Yogun bakım hekimi, hemşire, solunum terapisti ve diyetisyen ile koordineli calışmak tedavinin başarısı icin şarttır.
