...
description: "Maitland, Mulligan ve Kaltenborn konseptleriyle manuel terapi yaklaşımım. Eklem mobilizasyonu ile manipülasyon farkı ve kanıta dayalı klinik akıl yürütme."
...
Fizyoterapi pratiğimin merkezinde eller var. Değerlendirme sırasında elle elde edilen bilginin, görüntüleme yöntemlerinin verdiği bilgiyi tamamlayıcı nitelikte olduğunu düşünüyorum. Yalova'daki klinik pratiğimde manuel terapiyi programın bir bileşeni olarak uyguluyorum. Manuel terapi, kas iskelet sistemi sorunlarının değerlendirilmesi ve tedavisinde kullandığım yöntemlerden biri. Bu yazıda manuel terapinin ne olduğunu, hangi durumlarda uyguladığımı ve tedavi felsefemi detaylı olarak paylaşmak istiyorum.
...
Klinik deneyimlerimde gözlemlediğim en önemli nokta, manuel terapinin tek başına bir tedavi olmadığıdır. Manuel terapi; egzersiz terapisi, hasta eğitimi ve fonksiyonel rehabilitasyonla birlikte planlandığında literatürde daha olumlu sonuçlar bildirilmektedir. 2017 yılında British Medical Journal'da yayımlanan bir sistematik derlemede, bel ağrısı tedavisinde manuel terapinin egzersizle kombine edildiğinde tek başına egzersizden daha etkili olduğu gösterilmiştir.
...
Manuel terapi uygularken izlediğim sistematik bir klinik akıl yürütme süreci vardır. Bu süreç, kapsamlı bir fonksiyonel değerlendirmeden uygun tedavi planına uzanan bir yol haritası oluşturur.
...
Klinik deneyimimde gözlemlediğim önemli bir nokta var: aynı hekim tanısını alan iki hasta bile birbirinden farklı tedavi yaklaşımları gerektirebilir. Bir bel ağrısı tablosunda sorun faset eklem kaynaklı olabilirken, diğerinde farklı bir mekanizmayla ilişkili olabilir. Bu nedenle fizyoterapi planımı her zaman fonksiyonel değerlendirmede elde ettiğim klinik bulgulara dayandırırım; yalnızca etikete değil, bireyin bulgularına odaklanarak hareket ederim.
...
2018 yılında JAMA dergisinde yayımlanan bir randomize kontrollü çalışmada, akut bel ağrısında spinal manipülasyonun ilk 6 hafta içinde ağrı ve fonksiyonda anlamlı iyileşme sağladığı bildirilmiştir. Klinik deneyimimde de bazı hastalarda erken dönemde rahatlama bildirildiğini gözlemliyorum; ancak tedaviye verilen yanıt bireysel olarak değişir ve süreci her hasta için ayrı ayrı takip ederim.
...
Manuel terapi, fizyoterapi pratiğimin vazgeçilmez bir bileşenidir. Ellerle değerlendirme ve tedavi etme becerisi, yılların deneyimi ve sürekli eğitimle gelişen bir alandır. Bu beceriyi güncel bilimsel kanıtlarla desteklemek ve her hastaya özel bir tedavi planı oluşturmak, sürece yaklaşımımın temel ilkesidir.
