...
description: "İnme, felç, MS ve Parkinson süreçlerinde nörolojik rehabilitasyon yaklaşımım. Bobath, PNF teknikleri ve erken dönem değerlendirmenin yeri hakkında bilgi."
...
faqItems:
  ...
  - question: "Felc sonrası hastalar tamamen iyileşebilir mi?"
    answer: "Iyileşme derecesi inmenin tipine, buyukluğune, etkilenen beyin bolgesine ve rehabilitasyona başlama zamanına gore kişiden kişiye değişir. Literatürde hastaların bir bolumunun fonksiyonel bağımsızlığını geri kazanabildiği bildirilmektedir. Tam iyileşme hicbir vakada onceden taahhüt edilemez; sistematik rehabilitasyonun amacı hastanın mevcut potansiyelini desteklemektir."
  ...
  - question: "Parkinson hastalarında fizyoterapi ne kadar etkilidir?"
    answer: "Literatürde fizyoterapinin Parkinson hastalığında yurume bozuklukları, denge problemleri, rijidite ve fonksiyonel kayıpların yonetiminde olumlu sonuclar bildirildiği gorulmektedir. Duzenli egzersiz programlarının duşme riskini azaltmaya ve yaşam kalitesini desteklemeye katkı sağlayabileceği belirtilmektedir. Yanıt kişiden kişiye değişir ve fizyoterapi ilaç tedavisiyle birlikte surdurilmelidir."
...
Beyin, plastik bir organdır. Noropastisise adı verilen bu ozellik sayesinde beyin, hasar goren bolgelerin gorevlerini sağlam bolgelerle telafi edebilir, yeni sinir bağlantıları oluşturabilir. Norolojik rehabilitasyonun temel amacı, bu nöroplastisite mekanizmasından yararlanarak hastanın fonksiyonel kapasitesini artırmaktır.
...
2011 yılında The Lancet Neurology dergisinde yayımlanan bir calışma, inme sonrası ilk uc ayda uygulanan yoğun rehabilitasyonun, gecikmiş rehabilitasyona gore daha olumlu sonuclarla ilişkili olduğunu ortaya koymuştur. Klinik deneyimlerimde de erken donemde değerlendirilen hastalarda rehabilitasyon surecine genellikle daha olumlu yanıt alındığını gozlemliyorum; ancak bu yanıt her hastada farklılık gosterir.
...
- Noroloji hekimi ile ilaç tedavisi ve takip
...
Bu multidisipliner yaklaşım, hastanın tum ihtiyaclarının butuncul şekilde değerlendirilmesini ve rehabilitasyon hedeflerine yonelik koordineli bir surec yurutulmesini destekliyor.

## Sonuc

Norolojik rehabilitasyon, sabır, deneyim ve sistematik yaklaşım gerektiren bir tedavi alanıdır. Inme, MS, Parkinson ve diğer norolojik hastalıklarda erken donemde başlanan ve yoğun şekilde surdurulen rehabilitasyon, hastaların fonksiyonel bağımsızlıklarını onemli olcude geri kazanmalarını sağlayabilir.

Klinik deneyimlerimde Bobath, PNF ve GTOS terapi gibi yontemleri hastanın durumuna gore kombine ediyorum; literatürde bu yaklaşımlarla olumlu sonuclar bildirilmektedir. Her hastanın norolojik tablosu farklıdır, alınan yanıt kişiden kişiye değişir ve tedavi programları buna gore bireyselleştirilmelidir.
