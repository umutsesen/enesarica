...
Bel veya boyun ağrılarınızda McKenzie değerlendirmesi yaptırmak ve size uygun tedavi programı oluşturmak için [iletişim](/iletisim) — kurucusu olduğum [Yalova Fizyoterapi](https://www.yalovafizyoterapist.com) kliniğinin Yalova, İstanbul ve İzmir iletişim kanallarına de başvurabilirsiniz sayfasından randevu alabilirsiniz.
