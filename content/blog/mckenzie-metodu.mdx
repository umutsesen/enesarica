...
Bel fıtığında kullandığım yaklaşımlardan biri McKenzie Mekanik Tanı ve Tedavi (MDT) metodudur. Robin McKenzie tarafından 1981'de geliştirilen bu sistem, hastanın kendi kendine tedavi edebilme kapasitesini merkeze alan, egzersiz tabanlı bir yaklaşımdır.
