...
## Doğru Hekime Başvurmak

Boyun fıtığı tanısı aldığınızda öncelikle nöroloji veya beyin cerrahisi hekimine başvurmanız gerekir. Cerrahi endikasyon yoksa, fizyoterapist olarak konservatif tedavi sürecini yönetiyorum. [Fizyoterapist nasıl seçilir](/blog/fizyoterapist-nasil-secilir) yazımda bu konuya dair detaylı bilgiler paylaştım.
...
Boyun fıtığı uygun tedavi edilse bile tekrarlama riski taşır. Egzersiz programına düzenli devam etmek, ergonomik kurallara uymak ve boyun kaslarını güçlü tutmak, literatürde tekrarlama riskini azaltan faktörler arasında gösterilmektedir. [Ofiste boyun ağrısı](/blog/ofiste-boyun-agrisi) yazımda paylaştığım önlemlere dikkat etmek tekrarlama riskini azaltmaya yardımcı olabilir.
